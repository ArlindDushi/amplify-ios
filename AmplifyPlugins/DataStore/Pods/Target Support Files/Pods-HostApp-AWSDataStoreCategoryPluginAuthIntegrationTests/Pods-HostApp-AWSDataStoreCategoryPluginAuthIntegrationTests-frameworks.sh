...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AmplifyTestCommon/AmplifyTestCommon.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AmplifyPlugins-AWSAPIPlugin-AWSCognitoAuthPlugin/AmplifyPlugins.framework"
